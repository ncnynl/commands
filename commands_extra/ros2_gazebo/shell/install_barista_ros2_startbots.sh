#!/bin/bash
################################################
# Function : Install barista_ros2 startbots branch
...
echo "$(gettext "Install barista_ros2 startbots branch")"

#source from https://bitbucket.org/theconstructcore/barista_ros2  branch: startbots
...
cd ~/$workspace/src
git clone -b startbots https://gitee.com/ncnynl/barista_ros2
