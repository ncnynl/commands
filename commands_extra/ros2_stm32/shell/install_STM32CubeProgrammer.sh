#!/bin/bash
################################################################
# Function : install_STM32CubeProgrammer 
# Desc     : 用于安装STM32CubeProgrammer的脚本                         
# Platform : ubuntu                                
# Version  : 1.0                               
# Date     : Thu Sep 28 10:13:36 AM CST 2023                            
# Author   : ncnynl                             
...
echo "$(gettext "install_STM32CubeProgrammer")"
...
function rcm_execute() {
    ...
    # start
    echo "install_STM32CubeProgrammer start ..."
    _rcm_run_ $*
