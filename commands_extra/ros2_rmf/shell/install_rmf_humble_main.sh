#!/bin/bash
################################################
# Function : Install ROS2 humble rmf apt version humble-main branch
# Desc     : 用于源码方式安装ROS2 humble-main版RMF框架的脚本                              
# Platform : ubuntu                                
# Version  : 1.0                               
...
echo "$(gettext "Install ROS2 humble rmf apt version humble-main branch")"
