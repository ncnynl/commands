#!/bin/bash
################################################################
# Function : Launch rmf_barista_ff_6_destination_request_2                                  
# Desc     : 目的地请求，允许对机器人2发出单一目的地命令,请在终端执行,重复执行需要ID加1
...
echo "$(gettext "Launch rmf_barista_ff_6_destination_request_2")"
