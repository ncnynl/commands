#!/bin/bash
################################################
# Function : install turtlebot3 ros2 Foxy   
...
if [ -d ~/ros2_tb3_ws/src ]; then
    ...
    # wget https://ghproxy.com/https://raw.githubusercontent.com/ROBOTIS-GIT/turtlebot3/foxy-devel/turtlebot3.repos
    ...
    git clone -b foxy-devel https://ghproxy.com/https://github.com/ROBOTIS-GIT/turtlebot3_simulations.git
