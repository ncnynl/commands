#!/bin/bash
################################################
# Function : Install openmanipulator_x ROS1 melodic  source 
# Desc     : 用于源码方式安装ROS1 melodic 版本openmanipulator_x的脚本                              
# Platform : ubuntu                                
# Version  : 1.0                               
...
echo "$(gettext "Install openmanipulator_x ROS1 melodic  source")"
