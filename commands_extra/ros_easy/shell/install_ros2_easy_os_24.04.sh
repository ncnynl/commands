#!/bin/bash
################################################
# Function : Install ros2 easy 24.04 
# Desc     : 用于制作ROS-EASY-OS-AMD 24.04镜像自动化脚本                               
# Platform : ubuntu                                
# Version  : 1.0                               
# Date     : 2024-07-02                            
# Author   : ncnynl                             
...
echo "$(gettext "Install ros2 easy 24.04")"

echo "ROS-EASY-OS-AMD 24.04 Cubic ISO automation install script"
echo "Not Yet Tested"
# exit 0 

pwd=$(pwd)      
echo "install ROS2 jazzy"
rcm -si ros2 install_ros2_now 
