#!/bin/bash
################################################
# Function : Install ros2 easy arm 24.04  
# Desc     : 用于制作ROS-EASY-OS-ARM 24.04镜像自动化脚本                            
# Platform : ubuntu                                
# Version  : 1.0                               
# Date     : 2024-07-02                            
# Author   : ncnynl                             
...
echo "$(gettext "Install ros2 easy arm 24.04")"

echo "ROS-EASY-OS-ARM 24.04 for RPI4 automation install script"
echo "Not Yet Tested"
# exit 0 
