#!/bin/bash
################################################################
# Function : install_ros2_laser_filters related usage
# Desc     : 安装ros2版laser_filters包的脚本                        
# Platform : ubuntu                                
# Version  : 1.0                               
# Date     : Mon Oct 30 02:54:58 PM CST 2023                           
# Author   : ncnynl                             
...
function _rcm_ros_install_() {
    ...
    if [ -d ~/$workspace/src/$package_name ]; then
        ...
        git clone -b ros2 https://github.com/ros-perception/laser_filters
...
function _rcm_usage_() {
    cat << EOF
Usage:
    install_ros2_laser_filters --along --blong argb --clong argc

Description:
    install_ros2_laser_filters related usage.
...
function rcm_execute() {
    ...
    # start
    echo "install_ros2_laser_filters start ..."
    _rcm_ros_install_ $*
